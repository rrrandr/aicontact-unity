...
#pragma warning restore IDE0065
    ...
    public sealed class ConnectionListAnnotation : ListAnnotation<ConnectionAnnotation>
    {
        ...
        [Range(0, 1)] public float _lineWidth = 1.0f;
        public List<ConnectionAnnotation> connectionAnnotationsList;
        ...
        protected override ConnectionAnnotation InstantiateChild(bool isActive = true)
        {
            ...
            connectionAnnotationsList.Add(annotation);
        ...
        public void ToggleAnnotationConnection(bool toggle)
        {
            foreach (var point in connectionAnnotationsList)
            {
                point.GetComponent<LineRenderer>().enabled = toggle;
            }
        }
    }
}
