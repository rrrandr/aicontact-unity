...
#pragma warning restore IDE0025
        ...
        private IEnumerator Start()
        {
            ...
            if (availableSources != null && availableSources.Length > 0)
            {
                ...
                foreach (var webCam in availableSources)
                {
                    if (webCam.name.Contains("FaceTime HD Camera"))
                    {
                        Debug.Log("Web Cam selected: " + webCam.name);
                        webCamDevice = webCam;
                        break;
                    }
                }
                ...
                Debug.Log("Web Cam selected: " + availableSources[0].name);
        ...
        public override IEnumerator Play()
        {
            ...
            webCamTexture.Play();
            AICONTACTManager.Instance.SetWebcamTexture(webCamTexture);
        ...
        public override IEnumerator Resume()
        {
            ...
            {
                webCamTexture.Play();
                AICONTACTManager.Instance.ChooseFilterQuality(webCamTexture.width, webCamTexture.height);
            }
            yield return WaitForWebCamTexture();
        }
        ...
        private void InitializeWebCamTexture()
        {
            ...
            if (webCamDevice is WebCamDevice valueOfWebCamDevice)
            {
                ...
                webCamTexture.name=valueOfWebCamDevice.name;
                return;
            }
