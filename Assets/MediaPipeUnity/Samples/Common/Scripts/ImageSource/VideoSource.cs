    ...
    public class VideoSource : ImageSource
    {
        ...
        private VideoClip video
        {
            ...
            set
            {
                ...
                //resolution = new ResolutionStruct((int) GetComponent<VideoPlayer>().height, (int)GetComponent<VideoPlayer>().width, (int)GetComponent<VideoPlayer>().frameRate);
                //Debug.Log("Res Log: " + _video.width + " " + _video.height);
                //Debug.Log("Res Log: " + GetComponent<VideoPlayer>().width + " " + GetComponent<VideoPlayer>().height);
            }
        }
